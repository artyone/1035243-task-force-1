    ...
    <main>
        <div class="landing-container">
            <div class="landing-top">
                ...
                <a class="button" href="/registration">Создать аккаунт</a>
            </div>
                ...
                <div class="landing-bottom-container">
                    ...
                    <div class="landing-task">
                        ...
                        <div class="landing-task-description">
                            <h3><a href="/task/view/<?= $task->id ?>" class="link-regular"><?= $task->name ?></a></h3>
                            <p><?= substr($task->description, 0, 73) . '...' ?></p>
                        </div>
                        <div class="landing-task-info">
                            <div class="task-info-left">
                                <p><a href="" class="link-regular"><?= $task->category->name ?></a></p>
                                <p><?= helpers\WordHelper::getStringTimeAgo($task->creation_time) . ' назад' ?></p>
                            </div>
